...
using HDK700.Models;
using HDK700.Models.Process;

namespace HDK700.Controllers;

public class GiaiPhuongTrinhController : Controller
{
     private readonly ILogger<GiaiPhuongTrinhController> _logger;

    public GiaiPhuongTrinhController(ILogger<GiaiPhuongTrinhController> logger)
    {
        _logger = logger;
    }
